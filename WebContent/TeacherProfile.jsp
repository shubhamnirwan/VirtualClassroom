...
<title>VClassroom-Teacher Profile</title>
<!--Additional CSS-->
    ...
    <form class="navbar-form navbar-left" action="/action_page.php">
      <div class="input-group">
        ...
        <div class="input-group-btn">
          ...
          <li class="active"><a href="TeacherProfile.jsp">Profile</a></li>
...
<div class="row body">
    ...
    <div class="col-lg-9 feeds_panel">
          <!--   <div class="post feed margin-top-10">
            ...
            <div class="post feed margin-top-10">
                <div class="post">Degree: <%if(user!=null) out.print(user.getDegree());%></div>
            </div>
            <div class="post feed margin-top-10">
                <div class="post">Designation: <%if(user!=null) out.print(user.getDesignation());%></div>
            </div>
            <div class="post feed margin-top-10">
